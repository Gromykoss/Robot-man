# DISTRIBUTION PLAYBOOK (ex-SHADOWBAN_RECOVERY)

> ⚠️ **СТАТУС 05.09.2026:** файл исторический. Ban OFF (30.08 чекеры + канон 05.09) — «recovery»-протокол неактуален.
> Живая часть: раздел «ОБНОВЛЕНИЕ ДИАГНОЗА 30.08» (TweepCred/дистрибуция) — действующий playbook.
> Цели +1000/30d — архивный сценарий. Живая тактика — TACTICS.md (утренний крон).
