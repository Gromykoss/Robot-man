...
## 2026-07-17 — Discord Sync

- Проверены последние 5 постов из `published_posts.jsonl` (16 строк) vs Discord #robot-human (10 сообщений)
- **Все посты синхронизированы:**
  - `2077258456482947162` (15.07) — ❌ 404 (удалён)
  - `2077258660112163081` (15.07) — ✅ в Discord (sync 15.07)
  - `2077342251341029628` (15.07) — ✅ в Discord (sync 15.07)
  - `2077807056875033015` (16.07, рус.) — ❌ 404 (удалён), был в Discord (auto-push)
  - `2077807401672098229` (16.07, англ.) — ✅ в Discord (auto-push через post_with_log.sh)
- **Итог:** расхождений нет, Discord актуален
