...
## 2026-07-19 — Discord Sync (cron run)

- Проверены последние 5 постов из `published_posts.jsonl` (20 строк) vs Discord #robot-human (50 сообщений)
- Все 5 последних постов в Discord: `2078492463111577932`, `2078074865697906859`, `2077641197636432318`, `2077342251341029628`, `2077807401672098229`
