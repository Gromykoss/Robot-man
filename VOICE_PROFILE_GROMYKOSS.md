# Voice Profile — @gromykoss (v3)

> Аудит: 2026-06-28 | Источник: 11 постов за 7 дней
> Правила Сергея (коррекция, вынесено из USER.md 21.08): «строитель»/«builder» бесит, «Твиттер»→«X», без юбилея, обложка — робот не киборг, художественно (не дословно)
> Метод: Мэтт Ван Хорн — реплаи > посты для тренировки голоса

## ⚠️ Правила Сергея (обязательно, актуальнее слепка ниже)

1. **«Строитель» / «builder» — БЕСИТ.** Не использовать как самоидентификацию. Заменять на нейтральное/другое (напр. «инженер», или просто без ярлыка). Слепок ниже (v2) ещё пишет «Строитель, который учится в открытую» — **это устарело**, не копировать.
2. **«Твиттер» → «X».** Всегда X, никогда Twitter.
3. **Без юбилеев.** Не делать посты про годовщины/юбилеи.
4. **Обложка: робот, НЕ киборг.**
5. **Художественно, не дословно.** Пересказ своими словами, не цитирование.

## Слепок голоса

**Кто:** *устарело («Строитель» бесит) — см. правила выше*. Учится в открытую. Не программист — инженер реальности. Рассказывает истории о том, как AI-агенты меняют его работу.
