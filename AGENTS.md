...
| Morning Tracked Scan | `693d2bfee2df` | Ежедн 05:00 UTC | Сканирование отслеживаемых аккаунтов |
| KG rebuild | `4506b578cfa3` | Каждые 6ч | Knowledge Graph перестроение |
| Discord/Infra Sync | `32d46d9d7752` | Ежедн 04:00 UTC | GitHub + Obsidian + Discord синхронизация |
| Auto-CHRONOLOGY | `eef332c48459` | Ежедн 23:00 UTC | CHRONOLOGY.md для всех проектов |
| Follow drip | — | ⏸ НЕТ CRON | `mutuals_follow_back.py` — запускать вручную при recovery |
| Reply Engine | — | ⏸ ПАУЗА | Шаблоны = бан, не запускать |
